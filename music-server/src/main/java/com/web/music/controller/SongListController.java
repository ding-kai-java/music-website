...
import com.web.music.domain.SongList;
import com.web.music.service.impl.SongListServiceImpl;
...
public class SongListController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songListPic/**").addResourceLocations("file:E:\\openSources\\music-website\\music-server\\img\\songListPic\\");
        }
    }
