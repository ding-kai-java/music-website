...
import com.web.music.domain.Song;
import com.web.music.service.impl.SongServiceImpl;
...
public class SongController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songPic/**").addResourceLocations("file:E:\\openSources\\music-website\\music-server\\img\\songPic\\");
            registry.addResourceHandler("/song/**").addResourceLocations("file:E:\\openSources\\music-website\\music-server\\song\\");
        }
    }
    ...
    public Object addSong(HttpServletRequest req, @RequestParam("file") MultipartFile mpfile) {
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "music-server" + System.getProperty("file.separator") + "song";
